class jug:
    ...
    def set_jugs(self):
        print("Preparing jugs")
        jug1_cap=0
        jug2_cap=0
        jug1_cap = int(input("Capacity of Jug1: "))
        while jug1_cap <1:
            print("jug 1 capacity should not be less than 1")
            jug1_cap = int(input("Enter the capacity of Jug1 : "))

        jug2_cap = int(input("Enter the capacity of 2nd jug: "))
        while jug2_cap <1:
            print("Jug 2 capacity should not be less than 1")
            jug2_cap = int(input("Enter the capacity of 2nd jug: "))
